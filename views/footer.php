...
<div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
    ...
    <div class="social-icons" style="display: flex; gap: 10px; align-items: center;">
        ...
        <a href="https://dev.to/payracash" target="_blank">
            <svg width="12px" height="12px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <rect x="0" y="0" width="512" height="512" rx="40" ry="40" fill="#000000"/>
                <g transform="translate(256,265)" fill="#ffffff" text-anchor="middle" dominant-baseline="middle"><text x="0" y="0" font-family="Arial Black, 'Helvetica Neue', Helvetica, Arial, sans-serif" font-weight="900" font-size="180">DEV</text></g>
            </svg>
        </a>
        <a href="https://www.youtube.com/@PayraCash" target="_blank">
