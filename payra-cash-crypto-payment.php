...
define('PAYRACACR_CASH_PLUGIN_VERSION', '1.0.0');
define('PAYRACACR_CASH_DB_VERSION', '1');
...
{
    if (get_option(Xxxwraithxxx\PayraCashCryptoPayment\Constants::NEEDS_UPDATE, false)) {
        Xxxwraithxxx\PayraCashCryptoPayment\Update::update_db();
        delete_option(Xxxwraithxxx\PayraCashCryptoPayment\Constants::NEEDS_UPDATE);
    }
