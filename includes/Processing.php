...
class Processing extends Constants
{
    public function register()
    {
        ...
        add_action('wp_ajax_payra_cash_is_order_paid', [$this, 'payracacr_action_is_order_paid']);
        add_action('wp_ajax_nopriv_payra_cash_is_order_paid', [$this, 'payracacr_action_is_order_paid']);
    ...
    function payracacr_action_is_order_paid()
    {
        global $wpdb;
        ...
        $is_paid = $verifier->is_order_paid(
