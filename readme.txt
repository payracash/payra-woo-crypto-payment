...
Tags: Payra, payment, payment gateway, WooCommerce, crypto
...
== Changelog ==
= 1.0.0 – 12 Sept 2025 =
* Initial release of Payra Cash Crypto Payment for WooCommerce.
* Support for MetaMask and Web3 wallets.
* Transaction monitoring system (pending / paid / cancelled).
* Admin manual check for payments.

== Upgrade Notice ==
= 1.0.0 =
Initial release of the Payra Cash plugin.
